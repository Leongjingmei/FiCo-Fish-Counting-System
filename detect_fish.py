...
def detect(save_img=False):
    ...
    (save_dir if save_txt else save_dir).mkdir(exist_ok=True)  # make dir
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        cv2.putText(im0, yeey, (width - 410, 30), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 255, 0), 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='ficoflask/static/user_image_details/', help='save results to project/name')
